...
public class RemoveMenberGroupCommand extends SendManagementMessageCommand {
    private final int groupID;
    private final GroupClientRepository repo;
    private final int menber;

    public RemoveMenberGroupCommand(String commandId, int groupID, GroupClientRepository repo, int menber) {
